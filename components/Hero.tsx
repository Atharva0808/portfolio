...
export const Hero = () => {
    ...
    return (
        <div className="min-h-screen md:portrait:min-h-0 md:portrait:h-auto md:portrait:pb-32 w-full flex flex-col pt-32 md:pt-40 px-6 md:px-20 relative overflow-hidden bg-white dark:bg-black transition-colors duration-300">
            {/* Background Grid */}
